...
export const investmentProjects: Project[] = [
  ...
  },
  {
    ...
    description: "Рекордная доходность 30% годовых в Москве! Апарт-отель бизнес-класса на границе ЦАО, всего 5 км от Кремля. ДОМ УЖЕ СДАН И РАБОТАЕТ с 2023 года — получайте доход сразу после покупки! Ежемесячный доход до 135,000 рублей с одного апартамента. Высокая загрузка 85% круглый год благодаря идеальному расположению и профессиональному управлению Nice Loft. Проверенная инвестиция с подтвержденными показателями.",
    why: [
