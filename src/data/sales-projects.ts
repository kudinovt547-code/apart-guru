...
export const salesProjects: SalesProject[] = [
  ...
  // YES
  {
    id: "yes-primorsky",
    name: "YE'S Primorsky",
    address: "Камышовая ул., Приморский район",
    city: "Санкт-Петербург",
    class: "Апарт-комплекс бизнес-класса",
    priceFrom: 6_900_000,
    yield: 10,
    status: "for-sale",
    completionDate: "IV кв. 2026",
    description: "Крупный апарт-комплекс бизнес-класса от сети YE'S у метро Комендантский проспект. Собственная управляющая компания с полным циклом обслуживания — от поиска арендаторов до налоговой отчётности. Стабильная заполняемость за счёт близости к деловым центрам Приморского района.",
    features: [
      "Сеть YE'S — проверенный оператор",
      "У метро Комендантский проспект",
      "Полный цикл управления",
      "Бизнес-класс, от 6.9 млн"
    ],
    image: "/projects/yes-primorsky.jpg"
  },

  // WELL
  {
    id: "well-apart",
    name: "WELL Apart Hotel",
    ...
    yield: 10,
    status: "for-sale",
    description: "Современный апарт-отель на набережной Обводного канала. Полная чистовая отделка, три типа планировок (Studio, Standard, Deluxe). Управляющая компания берёт на себя всю операционку — аренда в пассивном режиме приносит до 10% годовых.",
    features: [
  ...
  // RBI
  {
    id: "rbi-artstudio-m103",
    name: "ARTSTUDIO M103",
    address: "Московский пр., 103",
    city: "Санкт-Петербург",
    class: "4★ апарт-отель",
    priceFrom: 8_250_000,
    yield: 9,
    status: "operational",
    monthlyPayout: 80_147,
    rating: 4.6,
    description: "Апарт-отель 4* от премиального застройщика RBI у метро Московские ворота. Загрузка 82%, средняя прибыль инвесторов 80 147 руб./мес. Международная классификация, высокие стандарты сервиса. Номера Deluxe показывают доходность до 145 829 руб./мес.",
    features: [
      "Застройщик RBI — премиум репутация",
      "Загрузка 82%, доходность 9%",
      "Средняя прибыль 80 147₽/мес",
      "У метро Московские ворота"
    ],
    image: "/projects/rbi-artstudio.jpg"
  },
  {
    id: "rbi-russian-seasons",
    name: "Russian Seasons",
    ...
    status: "operational",
    rating: 4.5,
    description: "Построенный и заселённый апарт-отель от RBI. Высокие оценки постояльцев обеспечивают стабильную заполняемость и доходность. Профессиональное управление, полная отделка и меблировка.",
    features: [
      "RBI — 30+ лет на рынке",
      "Высокий рейтинг постояльцев",
      "Стабильная заполняемость",
      "Построен и работает"
    ],
    image: "/projects/rbi-russian-seasons.jpg"
  },

  // ГОТОВЫЕ ОБЪЕКТЫ (работающие) — Inreit
  {
    id: "ligovsky-29",
    name: "Лиговский 29",
