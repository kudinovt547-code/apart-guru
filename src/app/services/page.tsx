...
const packages = [
  {
    ...
    price: "По запросу",
    description: "Я соберу для вас 3–5 подходящих вариантов под ваш бюджет и цель, с кратким разбором плюсов и минусов каждого.",
    features: [
  ...
  },
  {
    ...
    price: "По запросу",
    description: "Я веду вас от выбора объекта до закрытия сделки и контролирую выплаты и отчёты УК первые 6 месяцев.",
    features: [
...
const benefits = [
  {
    ...
    description: "Работаю только с вашим профилем и целями. Никаких шаблонов.",
  },
  {
    icon: <FileText className="h-6 w-6" />,
    title: "Проверка документов",
    description: "Анализирую договоры, ищу скрытые риски и невыгодные условия.",
  },
  {
  ...
  },
  {
    ...
    description: "Веду переговоры, помогаю с документами, контролирую условия.",
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Контроль выплат",
    description: "Проверяю отчёты УК и соответствие обещанной доходности.",
  },
];

const howItWorks = [
  { step: 1, title: "Собираю профиль", description: "Анкета: бюджет, цель, горизонт, риск-профиль" },
  { step: 2, title: "Формирую shortlist", description: "Подбираю 3–5 вариантов под ваши критерии" },
  { step: 3, title: "Считаю финмодель", description: "3 сценария доходности для каждого объекта" },
  { step: 4, title: "Проверяю УК и договор", description: "Ищу красные флаги и скрытые риски" },
  { step: 5, title: "Сравниваю и рекомендую", description: "Показываю лучший вариант и объясняю почему" },
  { step: 6, title: "Веду сделку", description: "Переговоры, документы, контроль условий" },
];
...
const faq = [
  ...
  },
  {
    ...
    answer: "Я зарабатываю на оплате моих услуг. Никаких откатов от застройщиков или УК — это противоречит моей задаче найти для вас лучший вариант, а не самый выгодный для продавца.",
  },
  {
    question: "Вы продаёте объекты или помогаете выбирать?",
    answer: "Я не продаю объекты. Я помогаю вам выбрать лучший вариант среди тех, что вы нашли, или среди тех, что я подобрал по вашим критериям. Моя задача — защитить ваши интересы, а не интересы продавца.",
  },
  {
    question: "Почему я должен вам платить, если застройщик предоставляет презентацию бесплатно?",
    answer: "Презентация застройщика — это маркетинг. Там красивые картинки и обещания, но нет реальных рисков, скрытых расходов и честных сценариев. Я даю независимый анализ и защищаю ваши деньги.",
  },
  {
    question: "Вы работаете только с новыми объектами или и со вторичкой?",
    answer: "Работаю и с новыми, и с работающими объектами. Главное — чтобы была прозрачность данных и возможность проверить реальную доходность.",
  },
  {
    question: "Что если объект не оправдает ожиданий после покупки?",
    answer: "Именно для этого я контролирую первые 6 месяцев. Если УК не выполняет обязательства или цифры не сходятся — я помогу разобраться и скорректировать ситуацию.",
  },
  {
  ...
  },
  {
    ...
    answer: "Я не оформляю ипотеку, но помогу оценить условия рассрочки от застройщика и подскажу, выгодно ли это с точки зрения доходности.",
  },
];
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <FadeIn delay={0.2}>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
              Я подберу 3–5 вариантов, посчитаю доходность по сценариям, проверю договор и УК, и проведу вас до сделки.
        ...
        <div className="container mx-auto px-4 text-center">
          <FadeIn>
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Заполните анкету, и я пришлю shortlist в течение 24 часов
            </p>
            <Button size="lg" onClick={() => setLeadFormOpen(true)} className="text-base">
