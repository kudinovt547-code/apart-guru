...
const APARTMENTS_DB = [
  ...
  { id: 117, city_code: 1, city: "Санкт-Петербург", name: "Yard Residence", class: "Premium", price_m2: 550000, adr_low: 8000, adr_high: 18000, occ_avg: 0.70, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  ...
  { id: 119, city_code: 1, city: "Санкт-Петербург", name: "One Trinity Place", class: "Elite", price_m2: 1100000, adr_low: 35000, adr_high: 70000, occ_avg: 0.60, uk_fee: 0.30, model: "Long", loc_class: "Prime" },
  ...
  { id: 207, city_code: 2, city: "Москва", name: "The Book", class: "Elite", price_m2: 950000, adr_low: 15000, adr_high: 25000, occ_avg: 0.72, uk_fee: 0.30, model: "Short", loc_class: "Prime" },
  { id: 208, city_code: 2, city: "Москва", name: "Neva Towers", class: "Premium", price_m2: 1100000, adr_low: 20000, adr_high: 35000, occ_avg: 0.65, uk_fee: 0.25, model: "Long", loc_class: "Prime" },
  { id: 209, city_code: 2, city: "Москва", name: "ОКО (OKO)", class: "Premium", price_m2: 900000, adr_low: 18000, adr_high: 30000, occ_avg: 0.65, uk_fee: 0.25, model: "Long", loc_class: "Prime" },
  { id: 210, city_code: 2, city: "Москва", name: "Башня Федерация", class: "Premium", price_m2: 950000, adr_low: 19000, adr_high: 32000, occ_avg: 0.68, uk_fee: 0.25, model: "Long", loc_class: "Prime" },
  { id: 211, city_code: 2, city: "Москва", name: "IQ-квартал", class: "Premium", price_m2: 850000, adr_low: 16000, adr_high: 28000, occ_avg: 0.70, uk_fee: 0.25, model: "Long", loc_class: "Prime" },
  ...
  { id: 213, city_code: 2, city: "Москва", name: "VTB Arena Park", class: "Premium", price_m2: 650000, adr_low: 12000, adr_high: 18000, occ_avg: 0.75, uk_fee: 0.25, model: "Hybrid", loc_class: "Center" },
  { id: 214, city_code: 2, city: "Москва", name: "Hill8", class: "Premium", price_m2: 600000, adr_low: 10000, adr_high: 15000, occ_avg: 0.74, uk_fee: 0.25, model: "Hybrid", loc_class: "Center" },
  { id: 215, city_code: 2, city: "Москва", name: "Roza Rossa", class: "Elite", price_m2: 1800000, adr_low: 45000, adr_high: 80000, occ_avg: 0.55, uk_fee: 0.35, model: "Short", loc_class: "Prime" },
  { id: 216, city_code: 2, city: "Москва", name: "LUNAR", class: "Premium", price_m2: 800000, adr_low: 14000, adr_high: 22000, occ_avg: 0.70, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  { id: 217, city_code: 2, city: "Москва", name: "High Life", class: "Premium", price_m2: 750000, adr_low: 13000, adr_high: 20000, occ_avg: 0.72, uk_fee: 0.25, model: "Short", loc_class: "Center" },
  { id: 218, city_code: 2, city: "Москва", name: "Cult", class: "Elite", price_m2: 1200000, adr_low: 25000, adr_high: 45000, occ_avg: 0.60, uk_fee: 0.30, model: "Short", loc_class: "Prime" },
  ...
  // --- 3. СОЧИ (ID 300+) ---
  { id: 301, city_code: 3, city: "Сочи", name: "Adagio Le Rond", class: "Premium", price_m2: 750000, adr_low: 8000, adr_high: 25000, occ_avg: 0.68, uk_fee: 0.30, model: "Short", loc_class: "Center" },
  ...
  { id: 304, city_code: 3, city: "Сочи", name: "Grand Royal Residences", class: "Deluxe", price_m2: 1900000, adr_low: 25000, adr_high: 70000, occ_avg: 0.55, uk_fee: 0.35, model: "Short", loc_class: "Prime" },
  { id: 305, city_code: 3, city: "Сочи", name: "Mantera Seaview", class: "Deluxe", price_m2: 3800000, adr_low: 50000, adr_high: 150000, occ_avg: 0.50, uk_fee: 0.40, model: "Short", loc_class: "Prime" },
  { id: 306, city_code: 3, city: "Сочи", name: "Reef Residence", class: "Elite", price_m2: 2500000, adr_low: 35000, adr_high: 90000, occ_avg: 0.45, uk_fee: 0.35, model: "Short", loc_class: "Prime" },
  { id: 307, city_code: 3, city: "Сочи", name: "Актер Гэлакси", class: "Premium", price_m2: 900000, adr_low: 13000, adr_high: 32000, occ_avg: 0.65, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  { id: 308, city_code: 3, city: "Сочи", name: "Сан-Сити", class: "Premium", price_m2: 800000, adr_low: 11000, adr_high: 28000, occ_avg: 0.65, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  { id: 309, city_code: 3, city: "Сочи", name: "Karat (Hyatt)", class: "Elite", price_m2: 2200000, adr_low: 32000, adr_high: 85000, occ_avg: 0.58, uk_fee: 0.35, model: "Short", loc_class: "Prime" },
  { id: 310, city_code: 3, city: "Сочи", name: "Metropol Residences", class: "Elite", price_m2: 1500000, adr_low: 25000, adr_high: 60000, occ_avg: 0.60, uk_fee: 0.35, model: "Short", loc_class: "Prime" },
  { id: 311, city_code: 3, city: "Сочи", name: "Нескучный сад", class: "Premium", price_m2: 650000, adr_low: 9000, adr_high: 21000, occ_avg: 0.68, uk_fee: 0.30, model: "Short", loc_class: "Center" },
  ...
  { id: 315, city_code: 3, city: "Сочи", name: "Monet (Моне)", class: "Premium", price_m2: 950000, adr_low: 11000, adr_high: 29000, occ_avg: 0.69, uk_fee: 0.30, model: "Short", loc_class: "Prime" },
  ...
  { id: 401, city_code: 4, city: "Калининград", name: "Atlantis (Зеленоградск)", class: "Premium", price_m2: 360000, adr_low: 6500, adr_high: 15000, occ_avg: 0.76, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  { id: 402, city_code: 4, city: "Калининград", name: "Royal Atlantis", class: "Elite", price_m2: 450000, adr_low: 9000, adr_high: 22000, occ_avg: 0.70, uk_fee: 0.30, model: "Short", loc_class: "Prime" },
  ...
  { id: 404, city_code: 4, city: "Калининград", name: "Midgard Club", class: "Premium", price_m2: 380000, adr_low: 7000, adr_high: 16000, occ_avg: 0.72, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
  ...
  { id: 502, city_code: 5, city: "Казань", name: "Odette", class: "Elite", price_m2: 500000, adr_low: 10000, adr_high: 20000, occ_avg: 0.65, uk_fee: 0.25, model: "Short", loc_class: "Prime" },
